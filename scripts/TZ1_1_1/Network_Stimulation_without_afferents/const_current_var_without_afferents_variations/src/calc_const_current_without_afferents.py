...
def run_simulation_task(params):
    try:
        ...
        # Имя файла на основе ID и параметров
        current_variation = [
            params["variation_I1"],
            params["variation_I2"],
            params["variation_I3"],
        ...
        muscle_csv_filename = f"constant_current_without_afferents_{muscle_file_id}_muscles.csv"
...
def main():
    ...
    if results:
        ...
        file_name = "../experiment_results_const_current_var_without_afferents.csv"
